...
import { AlertTriangle, CalendarDays, CheckCircle2, Clock3, Link2, MapPin, Save, Trash2 } from 'lucide-vue-next'
import { api } from '../api'
...
@media (max-width: 520px) { .page-title-actions { width: 100%; } .page-title-actions > * { flex: 1; } .detail-actions { width: 100%; } .detail-actions .secondary-button { flex: 1; } .stop-row { grid-template-columns: 78px 12px minmax(0, 1fr); gap: 8px; } }
</style>
