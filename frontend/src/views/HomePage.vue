...
.popular-city-carousel__rail { display: flex; gap: 16px; overflow-x: auto; padding: 2px 2px 10px; scroll-behavior: smooth; scroll-snap-type: x mandatory; scrollbar-width: none; touch-action: pan-y; cursor: grab; }
...
@media (max-width: 744px) { .home-page { padding-top: 16px; } .home-hero, .home-hero__content { min-height: 320px; } .home-hero__content { padding: 28px 24px; } .home-hero h1 { font-size: 24px; } .home-hero p { font-size: 14px; } .home-section { padding-top: 48px; } .section-heading, .section-heading__action { align-items: flex-start; flex-direction: column; gap: 8px; } .destination-explorer__heading .underlined-link { margin-top: 4px; } .popular-city-carousel__controls { display: none; } .popular-city-carousel__rail { margin-right: -24px; padding-right: 24px; } .popular-city-carousel__rail :deep(.popular-city-card) { width: min(78vw, 320px); flex-basis: min(78vw, 320px); } .discovery-layout { grid-template-columns: 1fr; gap: 0; } .attraction-showcase { grid-template-columns: 1fr; } .trend-panel { padding-left: 0; border-left: 0; } .planning-entry { grid-template-columns: 48px minmax(0, 1fr); align-items: start; margin-top: 48px; } .planning-entry .primary-button { grid-column: 1 / -1; width: 100%; } }
